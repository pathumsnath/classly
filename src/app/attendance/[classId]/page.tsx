    ...
    return (
      ...
      >
        ...
        {monthly.cycleProgress ? (
          // A cycle can straddle a calendar-month boundary, so there's no
          // "previous/next month" to page through here — just the current
          // cycle's own dates, whichever months they happen to fall in.
